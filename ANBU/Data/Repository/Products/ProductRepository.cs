...
namespace ANBU.Data.Repository.Products
{
    ...
    public class ProductRepository : Repository<Product>, IProductRepository
    {
                ...
                if (worksheetCount > 0)
                {
                    ...
                    try
                    {
                        for (int i = 2; i < totalRows; i++)
                        {
                            ...
                            if (category == null)
                            {
                                throw new Exception("Category name " + category + " does not exist. Please fix error and re-upload.");
                            }
                            ...
                            productsList.Add(new Product
                            {
                                ...
                                Price = Convert.ToDecimal(workSheet.Cell(i, 3).Value.ToString()),
        ...
        public async Task<StringBuilder> GenerateProductsExport(string filter, string userId)
        {
            try
            {
